...
-- Find the date of the first and last order, as well how many years of sales are available 
...
-- Find oldest and youngest customer
...
-- Which 5 product subcategories generate the highest revenue (w/ window function)
SELECT *
FROM (
	SELECT
		p.subcategory,
